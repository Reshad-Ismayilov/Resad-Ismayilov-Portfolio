...
const translations = {
  az: {
    ...
    hero_im: "Mən",
    hero_desc: "Müasir, performansa yönəlmiş bir Full Stack Developer olaraq, istifadəçi təcrübəsi, təmiz kod və genişlənmə imkanlarını ön planda tutan veb tətbiqlərin qurulmasına fokuslanıram. React ekosistemi, PHP, Laravel, MySQL, UI/UX prinsipləri və real layihələrdəki təcrübəmlə biznes çətinliklərinə effektiv texnoloji həllər təqdim edirəm.",
    ...
    about_summary_text: "Müasir, minimal və performansa yönəlmiş istifadəçi interfeyslərinin qurulmasına, həm frontend, həm də backend hissələrini birləşdirən, yüksək keyfiyyətli və istifadəçi mərkəzli veb təcrübələrin yaradılmasına fokuslanıram. Full Stack inkişafı sahəsində React, Next.js, PHP, Laravel, MySQL və UI/UX prinsiplərini tətbiq edərək genişlənə bilən və optimallaşdırılmış həllər hazırlayıram. Real layihələrdəki təcrübəm həm texniki, həm də dizayn baxımından balanslaşdırılmış məhsullar yaratmağa imkan verir.",
    ...
    info_title_val: "Full Stack Developer | Təlimçi",
    ...
    exp_title: "Təcrübə",
    exp_head_desc: "Full Stack inkişafı, mentorluq və tədrisə fokuslanmış peşəkar rollar.",
    ...
    exp_desc_3: "React.js, Next.js, PHP, Laravel və MySQL istifadə edərək responsive və yüksək performanslı tam yığma (full-stack) veb tətbiqlərin hazırlanması. REST API-lər, Redux və verilənlər bazası idarəetməsi ilə iş.",
    ...
    footer_subtitle: "Full Stack Developer | Təlimçi",
    footer_top: "Yuxarı qalx",
    footer_rights: "Bütün hüquqlar qorunur.",
    typing_roles: ["Full Stack Developer", "Təlimçi"]
  },
  en: {
    ...
    hero_im: "I am",
    hero_desc: "As a modern, performance-oriented Full Stack Developer, I focus on building web applications that prioritize user experience, clean code, and scalability. With experience in the React ecosystem, PHP, Laravel, MySQL, UI/UX principles, and real-world projects, I deliver effective technological solutions to business challenges.",
    ...
    about_summary_text: "I focus on building modern, minimal, and performance-oriented user interfaces, combining both frontend and backend to create high-quality and user-centered web experiences. In Full Stack development, I apply the React ecosystem, Next.js, PHP, Laravel, MySQL, and UI/UX principles to develop scalable and optimized solutions. My experience with real-world projects allows me to create products that are well-balanced from both a technical and design perspective.",
    ...
    info_title_val: "Full Stack Developer | Instructor",
    ...
    exp_head_desc: "Professional roles focused on full-stack development, mentoring and instruction.",
    ...
    exp_desc_3: "Developing responsive and high-performance full-stack web applications using React.js, Next.js, PHP, Laravel and MySQL. Working with REST APIs, Redux and database management.",
    ...
    footer_subtitle: "Full Stack Developer | Instructor",
    footer_top: "Back to top",
    footer_rights: "All rights reserved.",
    typing_roles: ["Full Stack Developer", "Instructor"]
  },
  ru: {
    ...
    hero_im: "Я",
    hero_desc: "Как современный, ориентированный на производительность Full Stack разработчик, я специализируюсь на создании веб-приложений, в которых приоритет отдается пользовательскому опыту, чистому коду и масштабируемости. Имея опыт работы в экосистеме React, PHP, Laravel, MySQL, принципах UI/UX и реальных проектах, я предлагаю эффективные технологические решения для бизнес-задач.",
    ...
    about_summary_text: "Я специализируюсь на создании современных, минималистичных и ориентированных на производительность пользовательских интерфейсов, сочетая как фронтенд, так и бэкенд для создания высококачественного и ориентированного на пользователя веб-опыта. В Full Stack разработке я применяю экосистему React, Next.js, PHP, Laravel, MySQL и принципы UI/UX для разработки масштабируемых и оптимизированных решений. Мой опыт работы над реальными проектами позволяет мне создавать продукты, сбалансированные как с технической, так и с дизайнерской точки зрения.",
    ...
    info_title_val: "Full Stack Developer | Преподаватель",
    ...
    exp_head_desc: "Профессиональные роли, ориентированные на full-stack разработку и обучение.",
    role_instructor: "Frontend Преподаватель",
    role_dev: "Full Stack Разработчик",
    ...
    exp_desc_3: "Разработка адаптивных и высокопроизводительных full-stack веб-приложений с использованием React.js, Next.js, PHP, Laravel и MySQL. Работа с REST API, Redux и управлением базами данных.",
    ...
    footer_subtitle: "Full Stack Developer | Преподаватель",
    footer_top: "Наверх",
    footer_rights: "Все права защищены.",
    typing_roles: ["Full Stack Developer", "Преподаватель"]
  }
};
