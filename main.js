...
const translations = {
  az: {
    ...
    order_title: "Xidmətlər və Sifariş",
    order_head_desc: "Peşəkar veb saytların və mobil tətbiqlərin (iOS/Android) ən qısa müddətdə hazırlanması.",
    order_service_web: "Veb Saytların Hazırlanması",
    order_service_app: "Mobil Tətbiqlərin Hazırlanması",
    order_feature_time: "Ən qısa müddətdə təhvil",
    order_feature_payment: "Hissə-hissə və ya tam ödəniş imkanı",
    btn_order_now: "İndi Sifariş Et",
  ...
  en: {
    ...
    order_title: "Services & Order",
    order_head_desc: "Professional development of websites and mobile applications (iOS/Android) in the shortest time.",
    order_service_web: "Website Development",
    order_service_app: "Mobile App Development",
    order_feature_time: "Delivery in the shortest time",
    order_feature_payment: "Full or installment payment options",
  ...
  ru: {
    ...
    order_title: "Услуги и Заказ",
    order_head_desc: "Профессиональная разработка веб-сайтов и мобильных приложений (iOS/Android) в кратчайшие сроки.",
    order_service_web: "Разработка Веб-сайтов",
    order_service_app: "Разработка Мобильных Приложений",
    order_feature_time: "Сдача в кратчайшие сроки",
    order_feature_payment: "Возможность полной или частичной оплаты",
    btn_order_now: "Заказать Сейчас",
    proj_1_title: "SmartRent",
